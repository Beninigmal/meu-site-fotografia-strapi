...
export interface ApiPortifolioPortifolio extends Struct.CollectionTypeSchema {
  collectionName: 'portifolios';
  info: {
    displayName: 'Portifolio';
    pluralName: 'portifolios';
    singularName: 'portifolio';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSobreMimSobreMim extends Struct.CollectionTypeSchema {
  collectionName: 'sobre_mims';
  info: {
    displayName: 'SobreMim';
    pluralName: 'sobre-mims';
    singularName: 'sobre-mim';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    biografia: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTrabalhoTrabalho extends Struct.CollectionTypeSchema {
  collectionName: 'trabalhos';
  info: {
    displayName: 'Trabalho';
    pluralName: 'trabalhos';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::portifolio.portifolio': ApiPortifolioPortifolio;
      'api::sobre-mim.sobre-mim': ApiSobreMimSobreMim;
      'api::trabalho.trabalho': ApiTrabalhoTrabalho;
